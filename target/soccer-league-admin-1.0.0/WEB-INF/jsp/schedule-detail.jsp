...
<h1 class="mainHeader">Jornada ${scheduleNumber}</h1>

<hr />

<a href='<spring:url value="/schedule-admin.html" />' class="btn btn-lg btn-info" data-toggle="modal">Volver a "Jornadas"</a>
